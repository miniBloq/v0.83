...
/*##Ver si se usará:
BEGIN_EVENT_TABLE(BubbleComponentsManager, BubblePanel)
    //EVT_SIZE(BubbleComponentsManager::onSize)
END_EVENT_TABLE()
*/

BubbleComponentsManager::BubbleComponentsManager(   wxWindow* parent,
                                                    wxWindowID id,
...
BubbleComponentsManager::~BubbleComponentsManager()
{
...
void BubbleComponentsManager::onSize(wxSizeEvent& event)
{
    event.Skip();
}
*/
